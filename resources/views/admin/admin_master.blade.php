...
<head>
	...
	<meta name="author" content="{{Session::get('admin_name')}}">
...
<body>
	...
	<footer>
		...
		<p>
			<span style="text-align:left;float:left">&copy; 202 <a href="http://jiji262.github.io/Bootstrap_Metro_Dashboard/" alt="Bootstrap_Metro_Dashboard">Bootstrap Metro Dashboard</a></span>
